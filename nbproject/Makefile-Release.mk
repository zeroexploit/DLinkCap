...
${OBJECTDIR}/deamonizer.o: deamonizer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/deamonizer.o deamonizer.cpp
...
${OBJECTDIR}/wavehandler.o: wavehandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wavehandler.o wavehandler.cpp
